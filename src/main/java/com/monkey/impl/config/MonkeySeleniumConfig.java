...
public class MonkeySeleniumConfig extends MonkeyConfig {
	...
	/**
	 * Return the configured start url that will be opened when browser is
	...
	public void setStartUrl(final String startUrl) {
		final String calculatedUrl = this.getRootUrl();
		this.startUrl = calculatedUrl != null ? calculatedUrl : startUrl;
	}
	...
	public DesiredCapabilities getCapabilities() {
		if (Supportedbrowsers.internetexplorer.name().equals(this.browserName)) {
